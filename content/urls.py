...
from .views import (channel_area_action_view, create_channel_view, add_episode_view,
                    mention_author_view, add_link_view, choose_channel_to_add_episode_view)
...
urlpatterns = [
    ...
    path('channel_area/choose_your_channel/', choose_channel_to_add_episode_view, name='choose_your_channel'),
